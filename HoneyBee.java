		...
		for (int i = 0; i < strs.length; i++) {
			...
			if (strs[i].indexOf('-') == 0) {
				...
				if (idOfHoneyBee == 9) {
					...
					/*
					 * //第一象限
					 * if(angleOfDelta>=0&&angleOfDelta<=90&&angleOfHoneyBee>=angleOfDelta+90&&
					 * angleOfHoneyBee<=270+angleOfDelta){
					 * 
					 ...
					 * //第二象限
					 * }else
					 * if(angleOfDelta>=90&&angleOfDelta<=180&&angleOfHoneyBee>=0&&(angleOfHoneyBee<
					 * =angleOfDelta-90||angleOfHoneyBee>=angleOfDelta+90&&angleOfHoneyBee<=360)){
					 * // if(angleOfHoneyBee>=0&&angleOfHoneyBee<=angleOfDelta-90||angleOfHoneyBee>=
					 * angleOfDelta+90&&angleOfHoneyBee<=360){
					 * for(int idd=0;idd<beFound.length;idd++){
					 * beFound[idd]=false;
					 * }
					 * beFound[id]=true;
					 ...
					 * //第三象限
					 * }else
					 * if(angleOfDelta>=180&&angleOfDelta<=270&&(angleOfHoneyBee>=0&&angleOfHoneyBee
					 * <=angleOfDelta-90||angleOfHoneyBee>=angleOfDelta+90&&angleOfHoneyBee<=360)){
					 * // if(angleOfHoneyBee>=0&&angleOfHoneyBee<=angleOfDelta-90||angleOfHoneyBee>=
					 * angleOfDelta+90&&angleOfHoneyBee<=360){
					 * for(int idd=0;idd<beFound.length;idd++){
					 ...
					 * }//第四象限
					 * else
					 * if(angleOfDelta>=270&&angleOfDelta<=360&&angleOfHoneyBee>=angleOfDelta-270&&
					 * angleOfHoneyBee<=angleOfDelta-90){
